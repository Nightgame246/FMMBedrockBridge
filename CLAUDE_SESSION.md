...
### Offen
- **Manuelle Bedrock-Verifikation ausstehend:** SCP JAR auf TestServer01 → full Stop/Start → Bedrock-Client NPC anklicken → native Quest-Form erscheint?
- Branch `feat/em-quest-reroute` → merge nach main wenn Verifikation OK
- Upstream-Drafts (`docs/upstream-bugs/`) auf GitHub posten (macht Fabi)
